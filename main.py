...
def main():
    ...
    name = Name.get_curve_name(base_x=base_x, base_y=base_y, base_curve_coeffs=base_curve_coeffs, curls_x=curls_x,
                               curls_y=curls_y, curls_curve_coeffs=curls_curve_coeffs,
                               radius_curve_coeffs=radius_curve_coeffs, speed=speed, q=q, rad_f=rad_f,
                               NORMALISE_WAVES=NORMALISE_WAVES, ORTHOGONAL_WAVES=ORTHOGONAL_WAVES, C=C, latex=False)
